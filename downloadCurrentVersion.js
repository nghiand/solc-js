...
function getVersionList (cb) {
  ...
  https.get('https://raw.githubusercontent.com/nghiand/mcash-solc-bin/master/list.json', function (response) {
...
function downloadBinary (outputName, version, expectedHash) {
  ...
  https.get('https://raw.githubusercontent.com/nghiand/mcash-solc-bin/master/bin/' + version, function (response) {
    if (response.statusCode !== 200) {
      console.log('Error downloading file: ' + response.statusCode);
      process.exit(1);
    }
